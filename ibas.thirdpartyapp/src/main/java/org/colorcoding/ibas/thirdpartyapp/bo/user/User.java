...
public class User extends BusinessObject<User> implements IUser, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -134055134283300100L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_TPA_USER";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_TPA_USER";
	 ...
	 * 应用 属性
	 */
	@DbField(name = "Application", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	public static final IPropertyInfo<String> PROPERTY_APPLICATION = registerProperty(PROPERTY_APPLICATION_NAME,
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_APPLICATION_NAME)
	public final String getApplication() {
		return this.getProperty(PROPERTY_APPLICATION);
	}
	...
	public final void setApplication(String value) {
		this.setProperty(PROPERTY_APPLICATION, value);
	}
	 ...
	 * 属性名称-映射标记
	 */
	private static final String PROPERTY_MAPPEDID_NAME = "MappedId";

	/**
	 * 映射标记 属性
	 */
	@DbField(name = "MappedId", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	public static final IPropertyInfo<String> PROPERTY_MAPPEDID = registerProperty(PROPERTY_MAPPEDID_NAME, String.class,
			MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MAPPEDID_NAME)
	public final String getMappedId() {
		return this.getProperty(PROPERTY_MAPPEDID);
	}
	 ...
	 *            值
	 */
	public final void setMappedId(String value) {
		this.setProperty(PROPERTY_MAPPEDID, value);
	}
	 ...
	 * 属性名称-映射密码
	 */
	private static final String PROPERTY_MAPPEDPASSWORD_NAME = "MappedPassword";

	/**
	 * 映射密码 属性
	 */
	@DbField(name = "MappedPassword", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	public static final IPropertyInfo<String> PROPERTY_MAPPEDPASSWORD = registerProperty(PROPERTY_MAPPEDPASSWORD_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MAPPEDPASSWORD_NAME)
	public final String getMappedPassword() {
		return this.getProperty(PROPERTY_MAPPEDPASSWORD);
	}
	 ...
	 *            值
	 */
	public final void setMappedPassword(String value) {
		this.setProperty(PROPERTY_MAPPEDPASSWORD, value);
	}
