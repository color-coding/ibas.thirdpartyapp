...
public class UserMapping extends BusinessObject<UserMapping> implements IUserMapping {
	 ...
	 * 应用 属性
	 */
	@DbField(name = "Application", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 用户 属性
	 */
	@DbField(name = "User", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 访问数据 属性
	 */
	@DbField(name = "AccessData", type = DbFieldType.MEMO, table = DB_TABLE_NAME)
