...
@XmlType(name = UserMapping.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = UserMapping.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = UserMapping.BUSINESS_OBJECT_CODE)
public class UserMapping extends BusinessObject<UserMapping> implements IUserMapping {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -4900300077429338848L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = UserMapping.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_TPA_OUSM";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_TPA_USERMAPPING";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "UserMapping";
	 ...
	 * 应用 属性
	 */
	@DbField(name = "Application", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 用户 属性
	 */
	@DbField(name = "User", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 设置 属性
	 */
	@DbField(name = "Settings", type = DataType.MEMO, table = DB_TABLE_NAME)
	 ...
	 * 属性名称-访问数据
	 */
	private static final String PROPERTY_ACCESSDATA_NAME = "AccessData";

	/**
	 * 访问数据 属性
	 */
	@DbField(name = "AccessData", type = DataType.MEMO, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_ACCESSDATA = registerProperty(PROPERTY_ACCESSDATA_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_ACCESSDATA_NAME)
	public final String getAccessData() {
		return this.getProperty(PROPERTY_ACCESSDATA);
	}
	 ...
	 * @param value 值
	 */
	public final void setAccessData(String value) {
		this.setProperty(PROPERTY_ACCESSDATA, value);
	}
