...
namespace thirdpartyapp {
    export namespace ui {
        export namespace c {
            /** 列表视图-应用 */
            export class ApplicationListView extends ibas.BOListView implements app.IApplicationListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        that.fireViewEvents(that.editDataEvent,
                                            // 获取表格选中的对象
                                            openui5.utils.getSelecteds<bo.Application>(that.table).firstOrDefault()
                                        );
                                    }
                                }),
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        that.fireViewEvents(that.deleteDataEvent,
                                            // 获取表格选中的对象
                                            openui5.utils.getSelecteds<bo.Application>(that.table)
                                        );
                                    }
                                }),
