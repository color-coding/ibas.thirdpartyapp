...
namespace thirdpartyapp {
    export namespace ui {
        export namespace c {
            /** 选择视图-应用配置 */
            export class ApplicationConfigChooseView extends ibas.BOChooseView implements app.IApplicationConfigChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_applicationconfig_name"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "name",
                                    type: new sap.extension.data.Alphanumeric(),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_applicationconfig_group"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "group",
                                    type: new sap.extension.data.Alphanumeric(),
