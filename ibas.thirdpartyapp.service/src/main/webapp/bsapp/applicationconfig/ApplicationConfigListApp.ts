...
namespace thirdpartyapp {
    export namespace app {
        /** 列表应用-应用配置 */
        export class ApplicationConfigListApp extends ibas.BOListApplication<IApplicationConfigListView, bo.ApplicationConfig> {
            /** 应用标识 */
            static APPLICATION_ID: string = "26296bfe-5bb4-46df-ab9b-f5895e9e031b";
            /** 应用名称 */
            static APPLICATION_NAME: string = "thirdpartyapp_app_applicationconfig_list";
            /** 业务对象编码 */
            ...
            constructor() {
                ...
                this.boCode = ApplicationConfigListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.ApplicationConfig | bo.ApplicationConfig[]): void {
                let beDeleteds: ibas.IList<bo.ApplicationConfig> = ibas.arrays.create(data);
                // 没有选择删除的对象
