 ...
 * @author cxm
 */
public class WechatApplet extends WebApp {
    ...
    public IUserMapping fetchUser(Properties params) throws Exception {
        ...
        params.put("AppId", this.paramValue("AppId", ""));
        params.put("AppSecret", this.paramValue("AppSecret", ""));
...
//			condition.setValue(String.valueOf(this.getName()));
//			condition = criteria.getConditions().create();
//			condition.setAlias(UserMapping.PROPERTY_ACCOUNT.getName());
//			condition.setValue(this.paramValue("unionid", data));
...
//		}
        ...
        if (existUser == null) {
            ...
            userIF.setName(this.paramValue("nickname", "", params));
        ...
        userTA.setUser(code);
        userTA.setApplication(String.valueOf(this.getName()));
        try {
            userTA.setAccount(this.paramValue("OpenId", "", params));
        } catch (Exception e) {
            userTA.setAccount(this.paramValue("UnionId", "", params));
        }
